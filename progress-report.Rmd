...
##31- Analysing and extracting new features from `RATE_PLAN` and adding it to the predictions - Trial 3 (Tony)
Building on 23 (Trial 2), let's proceed to have a `RATE_PLAN_VALUE` for all the rate plans we have.
