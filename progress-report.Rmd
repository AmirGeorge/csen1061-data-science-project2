...
author: "Mimi Mimi, Amir George, Tony Foti"
date: "May 8, 2016"
output: html_document
---

#Initial exploratory analysis (Amir)
...
##26- Add weekday and weekend data (Abanoub)
...
##36- Ensemble Kaggle Submissions (Mimi)
...
When choosing high-correlated submissions the score changed slightly (which made sense). An example of that is that the score changed from `0.70053` to `0.70071` (best score so far) when we ensembled the submissions 25 & 26 with weights 1 and 3 respectively using the voting approach described here [kaggle_vote.py](https://github.com/MLWave/Kaggle-Ensemble-Guide/blob/master/kaggle_vote.py).
