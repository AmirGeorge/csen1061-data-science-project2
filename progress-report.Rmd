...
With addition to the CV we did on Azure server, we did another evaluation on Azure by splitting the train data into stratified samples where the data is to be trained is 70% of the whole data.
```{r}
evaluateModel <- read.csv('CrossValidationsDataFramesAzure/evaluateModel.csv')
evaluateModel %>% kable
```
